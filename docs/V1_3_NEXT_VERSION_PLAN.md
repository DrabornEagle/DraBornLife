...
| v1.3.4 | Gelir gider akışı geliştirme | Next |
| v1.3.5 | Alınacaklar ve ev kurulum bağlantısı | Waiting |
| v1.3.6 | Yıllık hedefler ve özel hedefler bağlantısı | Waiting |
| v1.3.7 | Veri sağlık kontrolü ve yedek doğrulama | Waiting |
...
- [x] Bugünün önceliği kartı eklendi.
- [x] Eksik veri uyarıları eklendi.
- [x] En kritik finans aksiyonu metni eklendi.
- [x] Taşınmaya kalan zamana göre öneri metni eklendi.
